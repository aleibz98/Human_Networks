...
highschool_edge<-read.csv("data/Highschool_network_edge.csv")
highschool_att <- read.csv("data/Highschool_network_att.csv")
facebook_att <- read.csv("data/Facebook_network_att.csv")
facebook_edge <- read.csv("data/Facebook_network_edge.csv")
```
...
```
```{r}
#find the node of the highest eigenvector centrality
# eigen_centrality(Highschool)
which.max(eigen_centrality(Highschool))
V(Highschool)[which.max(eigen_centrality(Highschool))]
